...
/// - Optional animator syncing + hit-stop feedback
/// </summary>
...
public class PlayerCombatController : MonoBehaviour
{
    ...
    public bool attackUsesAnimationEvents = true;
    ...
    private void HandleCombo()
    {
        ...
        if (anim != null)
        {
            anim.SetInteger(comboStepParam, comboStep == 0 ? 3 : comboStep);
            anim.SetTrigger(attackTriggerParam);
        }

        if (!attackUsesAnimationEvents)
        {
            DealDamage();
        }
    }
    ...
    private void TriggerHitStop()
    {
        ...
        hitStopRoutine = StartCoroutine(HitStopRoutine(hitStopDuration));
    }
